...
- **AI connections** — every person gets their own URL that turns all of the above into
  92 tools any MCP client can call (122 if you're an admin). Claude, Claude Code, ChatGPT,
...
would, then tells you how many tools answered — 92, or 122 if you're an admin.
...
92 tools. Eighty-five of them are the data tools across the four areas and your account;
