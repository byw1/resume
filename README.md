...
- **AI connections** — every person gets their own URL that turns all of the above into
  105 tools any MCP client can call (135 if you're an admin). Claude, Claude Code, ChatGPT,
...
would, then tells you how many tools answered — 105, or 135 if you're an admin.
...
105 tools. Ninety-eight of them are the data tools across the four areas and your account;
