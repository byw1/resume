...
- **AI connections** — every person gets their own URL that turns all of the above into
  107 tools any MCP client can call (137 if you're an admin). Claude, Claude Code, ChatGPT,
...
would, then tells you how many tools answered — 107, or 137 if you're an admin.
...
107 tools. One hundred of them are the data tools across the four areas and your account;
