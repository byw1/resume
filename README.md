...
- **AI connections** — every person gets their own URL that turns all of the above into
  86 tools any MCP client can call (116 if you're an admin). Claude, Claude Code, ChatGPT,
...
would, then tells you how many tools answered — 86, or 116 if you're an admin.
...
86 tools. Seventy-nine of them are the data tools across the four areas and your account;
