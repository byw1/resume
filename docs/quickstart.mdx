...
description: "Connect an assistant, teach it the rules, fill the brain, build the first resume. In that order — the order is the whole trick."
icon: "rocket"
---
