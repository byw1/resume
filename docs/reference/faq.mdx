...
<AccordionGroup>
  ...
  <Accordion title="What stops it inventing things on my resume?">
    ...
    from nothing. And your own **standing rules** are prepended to that briefing, so a
    thing you have been burned by is corrected before any work starts.
  ...
  <Accordion title="What is the difference between the app's Docs page and this manual?">
    The **Docs page inside your instance** is generated from your own deployment: your tool
    count, your skills, your connection URL, the descriptions your assistant actually
    receives. It cannot drift, because it is the server describing itself.

    **This manual** is the written guide to the product, and it is the same for every
    deployment.
  </Accordion>

  <Accordion title="Can I import my existing resume or LinkedIn export?">
    Not as a one-click import yet — that is the next thing being built.

    In the meantime, paste the contents of your resume in and ask for it to be filed
    against the right roles. It works, and it takes about a minute. Treat it as a floor:
    the resume is the compressed version of your career, and the point of the brain is to
    hold what compression threw away.
  </Accordion>
