...
| `PUBLIC_URL` | The sign-in address printed in the startup banner beside your owner password. Invite links come from **Public URL** in **Admin → Variables**, not from this. |
...
in **Admin → Variables** to the address people will actually use: invitation links and the
