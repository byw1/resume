---
title: "The eight workflows"
sidebarTitle: "Workflows"
description: "Multi-step jobs that come with every connection. They arrive as slash commands where prompts are supported, and as ordinary tools everywhere else."
icon: "list-ol"
---
...
| **MISSING** | The brain has nothing. Said plainly. |
...
| --- | --- |
| Anything about a current or past job | Appended to that role's brain dump, numbers kept |
