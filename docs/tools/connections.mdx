...
description: "Six tools for finding out who a connection belongs to, and for managing the wiring itself without opening a browser."
icon: "plug"
---
...
only the URL has leaked: rotating keeps the row, its name and its place in the list, and
kills the old address the moment it returns.
