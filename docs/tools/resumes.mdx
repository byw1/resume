...
description: "Fourteen tools for writing documents, checking their length before saving, publishing them to a link and exporting real PDFs."
icon: "file-lines"
---
...
_What changed against the base_
...
| `baseId` | string | Compare against this one instead of its recorded base |
...
_Which brain material backs each bullet_
