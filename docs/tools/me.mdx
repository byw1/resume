...
title: "Me tools"
sidebarTitle: "Me"
description: "Twenty-three tools over roles, backgrounds, highlights, notes, standing rules, the four supporting collections, and importing a resume you already have."
icon: "user"
---
...
_Import a resume into the brain_
...
| `create_base_resume` | boolean | Also build a first draft resume from the imported brain, named 'Base resume'. Offer this — it is usually why they pasted a resume. |
