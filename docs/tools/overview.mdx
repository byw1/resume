...
<Card title="Your own count, live" icon="plug" href="https://app.hired.tools/settings" horizontal>
  **Settings → Connections** shows what your account actually has — the header reads
  something like "108 tools · 8 workflows · 28 admin" — and **Test** proves it by calling
  the endpoint the way a client would.
</Card>
