...
| **What `tools/list` returns** | **87** | **117** |
{/* /generated:counts */}
...
<CardGroup cols={3}>
  ...
  <Card title="Resumes" icon="file-lines" href="/tools/resumes">
    12 tools · writing documents, previewing them, publishing, exporting.
  </Card>
...
That is 109. The remaining 8 are the [workflows](/workflows), which are
