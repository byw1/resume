...
| **What `tools/list` returns** | **85** | **115** |
{/* /generated:counts */}
...
<CardGroup cols={3}>
  <Card title="Me" icon="user" href="/tools/me">
    22 tools · roles, backgrounds, highlights, notes, standing rules, and the four supporting collections.
  </Card>
...
That is 107. The remaining 8 are the [workflows](/workflows), which are
