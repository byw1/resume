...
| **What `tools/list` returns** | **107** | **137** |
{/* /generated:counts */}
...
<CardGroup cols={3}>
  <Card title="Me" icon="user" href="/tools/me">
    23 tools · roles, backgrounds, highlights, notes, standing rules, the four supporting collections, and importing an existing resume.
  </Card>
  ...
  <Card title="Pipeline" icon="list-check" href="/tools/pipeline">
    35 tools · applications, stages, timeline, tasks, follow-ups, views, sharing, diagnosis.
  </Card>
...
That is 129. The remaining 8 are the [workflows](/workflows), which are
