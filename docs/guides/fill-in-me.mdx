...
<Note>
  If you already have a resume, paste it in as a starting background. It is a floor, not
  a ceiling: the resume is the compressed version, and the point of Me is to hold
