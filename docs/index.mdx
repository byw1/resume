...
description: "An applicant tracking system, for applicants. A career brain, a resume builder and a job-search CRM you host yourself, wired into the assistant you already talk to."
icon: "compass"
---
...
you paste one URL into Claude, Claude Code, ChatGPT, Cursor, VS Code or Windsurf, and
your assistant gets 73 tools (100 if you are an admin) plus eight ready-made workflows.
No feature is browser-only.
...
<CardGroup cols={2}>
  ...
  <Card title="Every tool" icon="wrench" href="/tools/overview">
    All 108 of them, by area, with the arguments and the ones that overwrite.
  </Card>
