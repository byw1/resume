  ...
  return (
    <textarea
      ...
      className={cn(
        ...
        "border-input bg-inset shadow-field flex min-h-20 w-full rounded-control border px-3 py-2 text-base transition-[color,box-shadow,border-color] duration-150 outline-none md:text-sm",
